  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mt-4 flex-1 grid grid-cols-4 gap-4">
        ...
        <h2 className="text-2xl font-bold mb-4">Other Logs</h2>
        {otherLogs.map((item) => {
            return (
              <div key={item.title} className="mt-5 p-2 rounded border-blue-100 border-2 cursor-pointer" onClick={() => {goToPage("studyingLogs", item.title)}}>
